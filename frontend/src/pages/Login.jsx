  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 via-blue-700 to-blue-900 relative overflow-hidden">
        ...
        <div className="absolute bottom-40 right-20 w-48 h-48 bg-blue-400/20 rounded-full blur-2xl"></div>
        ...
        <div className="relative z-10 flex flex-col justify-center items-center w-full p-12">
          <div className="text-center">
            ...
            <h1 className="text-4xl font-bold text-white mb-4">VendorPay</h1>
            <p className="text-xl text-blue-200 mb-8">MSME Vendor Payment Tracking System</p>
            ...
            <div className="space-y-4 text-left max-w-sm mx-auto">
              <div className="flex items-center space-x-3 text-blue-100">
                ...
                <span>Track vendor payments efficiently</span>
              </div>
              <div className="flex items-center space-x-3 text-blue-100">
                <div className="flex-shrink-0 w-8 h-8 bg-white/10 rounded-lg flex items-center justify-center">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span>Manage purchase orders seamlessly</span>
              </div>
              <div className="flex items-center space-x-3 text-blue-100">
                <div className="flex-shrink-0 w-8 h-8 bg-white/10 rounded-lg flex items-center justify-center">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-gray-900">VendorPay</h1>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl shadow-blue-900/5 p-8">
            ...
            <div className="mt-6 p-4 bg-blue-50 rounded-xl border border-blue-100">
              ...
              <div className="flex items-center justify-between text-sm">
                <span className="text-blue-600">Username: <strong>admin</strong></span>
                <span className="text-blue-600">Password: <strong>admin123</strong></span>
              </div>
            </div>
          </div>

          <p className="text-center text-sm text-gray-500 mt-6">
            © 2024 VendorPay. All rights reserved.
          </p>
        </div>
      </div>
    </div>
